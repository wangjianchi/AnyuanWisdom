...
public class RoundImage extends ImageView{
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.RoundImage);
        mBorderThickness = a.getDimensionPixelSize(
                R.styleable.RoundImage_border_thickness, 0);
        mBorderOutsideColor = a
                .getColor(R.styleable.RoundImage_border_outside_color,
                        defaultColor);
        mBorderInsideColor = a.getColor(
                R.styleable.RoundImage_border_inside_color  , defaultColor);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable.getClass() == NinePatchDrawable.class)
            return;
        Bitmap bitmap =  drawableToBitmap(drawable);// b.copy(Bitmap.Config.ARGB_8888, true);
