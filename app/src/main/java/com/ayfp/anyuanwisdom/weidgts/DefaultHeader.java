 ...
 */
public class DefaultHeader implements SpringView.DragHander {
...
//    private TextView headerTime;
    ...
    public DefaultHeader(Context context){
        this(context, R.drawable.progress_small,R.mipmap.arraw);
    }
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.spring_header, viewGroup, true);
        headerTitle = (TextView) view.findViewById(R.id.xlistview_header_hint_textview);
//        headerTime = (TextView) view.findViewById(R.id.default_header_time);
        headerArrow = (ImageView) view.findViewById(R.id.xlistview_header_arrow);
        headerProgressbar = (ProgressBar) view.findViewById(R.id.xlistview_header_progressbar);
...
//        }
    ...
    public void onLimitDes(View rootView, boolean upORdown) {
        if (!upORdown){
            headerTitle.setText(R.string.xlistview_header_hint_ready);
            if (headerArrow.getVisibility()== View.VISIBLE)
                headerArrow.startAnimation(mRotateUpAnim);
        }
        else {
            headerTitle.setText(R.string.xlistview_header_hint_normal);
            if (headerArrow.getVisibility()== View.VISIBLE)
    ...
    public void onStartAnim() {
        freshTime = System.currentTimeMillis();
        headerTitle.setText(R.string.xlistview_header_hint_loading);
