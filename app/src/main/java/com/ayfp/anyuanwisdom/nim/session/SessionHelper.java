...
import com.ayfp.anyuanwisdom.nim.session.action.AVChatAction;
import com.ayfp.anyuanwisdom.nim.session.action.FileAction;
import com.ayfp.anyuanwisdom.nim.session.activity.MessageHistoryActivity;
import com.ayfp.anyuanwisdom.nim.session.extension.CustomAttachParser;
import com.ayfp.anyuanwisdom.nim.session.extension.CustomAttachment;
import com.ayfp.anyuanwisdom.nim.session.viewholder.MsgViewHolderAVChat;
import com.ayfp.anyuanwisdom.nim.session.viewholder.MsgViewHolderDefCustom;
import com.ayfp.anyuanwisdom.nim.session.viewholder.MsgViewHolderFile;
