...
import com.ayfp.anyuanwisdom.nim.avchat.activity.AVChatExitCode;
import com.ayfp.anyuanwisdom.nim.avchat.constant.CallStateEnum;
import com.ayfp.anyuanwisdom.nim.avchat.widgets.MultiSelectDialog;
...
//        notifyOption.forceKeepCalling = false;
        ...
        AVChatManager.getInstance().call2(account, callTypeEnum, notifyOption, new AVChatCallback<AVChatData>() {
            ...
            public void onSuccess(AVChatData data) {
                ...
                if (callTypeEnum == AVChatType.VIDEO) {
                    ...
                    initLargeSurfaceView(NimCache.getAccount());
    ...
    public void initAllSurfaceView(String largeAccount) {
        ...
        avChatSurface.initSmallSurfaceView(NimCache.getAccount());
    }
